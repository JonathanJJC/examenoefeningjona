        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
                <form method="POST">
                  <h6>Login</h6>
                  <p><span ><?php echo ((isset($login) && $login != '') ? $login ."<br>" : '')?></span></p>
                  <label>Email:</label>
                  ...
                  <button type="submit" name="login" class="w3-button w3-theme"><i class="fa fa-pencil"></i>  Login</button>
                  <a href="signuptest.php"><button type="button" class="w3-button w3-theme"><i class="fa fa-pencil"></i>  Signup</button></a>
                </form>
            </div>
          </div>
        </div>
